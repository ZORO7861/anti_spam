...
async def commands_callbacc(_, cq: CallbackQuery):
    ...
    await asyncio.gather(
        cq.answer(),
        cq.message.delete(),
        spr.send_message(cq.message.chat.id, text=text, reply_markup=keyboard),
    )
...
async def help_parser(name, keyboard=None):
    ...
    return (
        f"Hello {name}, I'm SpamProtectionRobot, I can protect your group from Spam and NSFW media using machine learning. Choose an option from below.",
        keyboard,
    )
...
async def help_button(client, query: CallbackQuery):
    ...
    top_text = (
        f"Hello {u}, I'm SpamProtectionRobot, I can protect your group from Spam and NSFW media using machine learning. Choose an option from below."
    )
